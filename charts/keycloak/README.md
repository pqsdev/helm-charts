...
| `image.tag`                                   | Overrides the Keycloak image tag . A digest is also accepted. Is no value is specified the AppVersion is used                                                                                                                                                                     | `""`                                                                                                         |
...
| `database.url`                                | JDBC URL for the database                                                                                                                                                                                                                                                         | unset                                                                                                        |
